...
## Core Features
- [AI Development Tracking](features/ai-tracking.md)
...
- [Decision Tracking](advanced/decision-tracking.md)
- [Dataset Generation](advanced/dataset-generation.md)
- [Custom Configuration](advanced/configuration.md)

## Platform-Specific Guides
- [Windows Guide](platforms/windows.md)
- [macOS Guide](platforms/macos.md)
- [Linux Guide](platforms/linux.md)

## API Reference
- [Python API](api/python-api.md)
- [PowerShell API](api/powershell-api.md)
